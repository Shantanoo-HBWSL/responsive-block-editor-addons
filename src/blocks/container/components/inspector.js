            ...
            <InspectorControls key="inspector">
                ...
                <InspectorTab key={"content"}>
                    ...
                    <RbeaTabRadioControl
                        ...
                        value={containerSize}
                        onChange={(value) =>
                        setAttributes({ containerSize: value })
                        }
                        options={[
                        { value: "full-width", label: __("Full Width", "responsive-block-editor-addons") },
                        { value: "boxed", label: __("Boxed", "responsive-block-editor-addons") },
                        { value: "custom", label: __("Custom", "responsive-block-editor-addons") },
                        ]}
                        defaultValue={"full-width"}
                    />

                    {/* Content Width if Container Size is Full Width */}
                    {containerSize && containerSize === "full-width" && (
                        <RbeaTabRadioControl
                    ...
                    {/* Custom Width if Container Size is Custom */}
                    {containerSize && containerSize == "custom" && 
                    <TabPanel
                    ...
                    {/* Content Width For Boxed Content Width Type && Container Size is Full Width */}
                    {(containerSize && containerSize === "full-width") && (contentWidth && contentWidth === "boxed") && 
                    <TabPanel
                        className=" responsive-size-type-field-tabs rbea-responsive-controls responsive-size-type-field__common-tabs  responsive-inline-margin"
                        activeClass="active-tab"
                        tabs={[
